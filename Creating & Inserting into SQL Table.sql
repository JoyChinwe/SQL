----Creating & Inserting into SQL Table
...
select top 10* from [dbo].[company_regions]
...
select T1.region_id, T2.region_id, company_regions, country from company_regions T1
...
select company_regions, country from company_regions T1
